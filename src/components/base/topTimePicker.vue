...
<template>
  <div class="timePicker" :style="pickStyle">
    <div @click="showPickerClick" class="showText" :class="{'noChoose': timeStr === '请选择'}">
      <span v-text="timeStr" :style="{color: (isShowPicker) ? '#ff5353' : ''}"></span>
      <img class="downIcon" v-if="!isShowPicker" src="../../static/img/picker_down.png"/>
      <img class="downIcon" v-if="isShowPicker" src="../../static/img/picker_up.png"/>
    </div>
